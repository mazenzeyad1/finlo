...
async function main() {
    ...
    await prisma.account.upsert({
        ...
        create: {
            ...
            type: 'checking',
            currency: 'CAD',
            balance: new client_1.Prisma.Decimal(8250.75),
            mask: '1234'
        }
    });
    const transactions = [
        {
            ...
            amount: new client_1.Prisma.Decimal(-900),
        ...
        },
        {
            id: 'tx-payroll',
            description: 'Payroll',
            amount: new client_1.Prisma.Decimal(7000),
        ...
        },
        {
            id: 'tx-rent',
            description: 'Rent',
            amount: new client_1.Prisma.Decimal(-1200),
            date: new Date('2024-04-20'),
            pending: false
        },
        {
