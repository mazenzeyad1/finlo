...
let AuthController = class AuthController {
    ...
    async forgot(dto, userAgent, ip) {
        return this.authService.forgotPassword(dto, { userAgent, ip });
    }
    async reset(dto, userAgent, ip) {
...
__decorate([
    ...
    (0, throttler_1.Throttle)({ verify: { limit: 1, ttl: 60 } }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, throttler_1.Throttle)({ verify: { limit: 3, ttl: 300 } }),
...
__decorate([
    ...
    (0, throttler_1.Throttle)({ 'verify-resend': { limit: 1, ttl: 60 } }),
...
__decorate([
    ...
    (0, throttler_1.Throttle)({ reset: { limit: 5, ttl: 300 } }),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Headers)('user-agent')),
    __param(2, (0, common_1.Ip)()),
